            ...
            <div className="min-h-screen bg-page-bg text-white selection:bg-white selection:text-black">
                ...
                <main>
                    ...
                    <div className="max-w-[1400px] mx-auto px-6 pb-24">
                        <div className="border border-signal/20 bg-signal/5 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                            ...
                            <button
                                ...
                                className="bg-signal text-black font-heading font-bold uppercase px-8 py-4 tracking-widest hover:bg-white transition-colors"
                            >
